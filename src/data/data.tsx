...
export const project_data: ProjectDataInterface[] = [
  {
    ...
    desc: "A simple digital portfolio website that can be accessed by anyone through the internet, which aims to showcase my information, experience, skills, and work.",
    tech: ["TypeScript", "NextJs", "Tailwind"],
    url: "https://renesdwir.vercel.app/",
  },
  {
    img: "",
    title: "Mini Clothing",
    desc: "A mini marketplace website that sells various types of clothing based on several categories.",
    tech: [
      "TypeScript",
      "ReactJs",
      "Redux",
    ...
    url: "https://github.com/renesdwir/mini-clothing",
  },
  {
    img: "",
    title: "R Gaming Store",
    desc: "Website for top up items in games. \n I created a page for customers and also a dashboard for sellers.",
    tech: [
      "TypeScript",
      "NextJs",
      "ExpressJs",
    ...
    url: "https://github.com/renesdwir/renes-store",
  },
];
